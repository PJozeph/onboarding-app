  ...
  export class UserService {
     ...
     subject = new BehaviorSubject<User[]>([
      ...
      new User('2', 'Kis Balázs', 'assets/profile-picture.jpg', new GoalExtension( 
        [
          {goalId: '1', completed: false, comment: [ {uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }, ],name:'Complete Terminal Installation', 
            description:'The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.'},
          {goalId: '2', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Complete Card Activation', 
            description: 'The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.'},
          {goalId: '3', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Fix First Bug',  
            description:'The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.'},
          {goalId: '4', completed: false, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Complete Terminal Installation', description : 'lorem ipsum text'},
          {goalId: '5', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Complete Card Activation'},
          {goalId: '6', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Fix First Bug'},
          {goalId: '7', completed: false, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Complete Terminal Installation'},
          {goalId: '8', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Complete Card Activation'},
          {goalId: '9', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Fix First Bug'},
          {goalId: '9', completed: true, comment: [{uid : '1' , message: 'Comment1' }, {uid : '1' , message: 'Comment2' }],name:'Fix First Bug'},
        ])),
